<script>
  ...
  async function getTopTags(track) {
    const response2 = await fetch(
      `https://ws.audioscrobbler.com/2.0/?method=track.gettoptags&artist=${track.artist.name}&track=${track.name}&api_key=146b1de8e4d3c8c7b3efb8e22115d3af&format=json`
    );
